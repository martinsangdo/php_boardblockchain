...
<link rel="stylesheet" href="<?php echo PUBLIC_FOLDER; ?>css/styles.css" type="text/css" media="all"/>
...
<script type="text/javascript" src="<?php echo PUBLIC_FOLDER; ?>js/swiper.jquery.min.js"></script>
